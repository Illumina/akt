...
static void usage(){ 
    ...
    fprintf(stderr, "    -n, --nkeep                 number of tag SNPs to selection (default 20000)\n");
...
int thin_main(int argc,char **argv) 
{
    ...
    while ((c = getopt_long(argc, argv, "@:n:o:w:c:",loptions,NULL)) >= 0) {  
    switch (c)      {
case 'o': outfile = optarg; break;
case 'c': r2_thresh = atof(optarg); break;
case 'w': w = atoi(optarg); break;
case 'n': nkeep = atoi(optarg); break;
case '@': nthread = atoi(optarg); break;
