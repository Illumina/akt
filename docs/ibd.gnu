...
GNUTERM = "wxt"
set yrange[-1:6]
set xrange[-5000000:100000000]
unset ytics
set xlabel "Position (bp)"
set label 'IBDseq' at 40000000,5.5 right
set arrow 1000 from 41000000,5.5 to 45000000,5.5 nohead lt 1
set label 'AKT' at 40000000,5 right
set arrow 1001 from 41000000,5 to 45000000,5 nohead
